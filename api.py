...
class GetInstrumentoRequest(BaseModel):
    idInstrumentoIndividual: int | None = None
    nombreInstrumentoIndividual: str | None = None

class UpdateGInstrumentoRequest(BaseModel):
    idInstrumento: int | None = None
    nombreInstrumento: str | None = None
    nuevaCantidad: int

class GetInstrumentosPorGrupoRequest(BaseModel):
    idInstrumentoGrupo: int | None = None
    nombreInstrumentoGrupo: str | None = None
...
class GetPaquetePorEspecialidadRequest(BaseModel):
    ...
    nombreEspecialidad: str | None = None
...
class Pedido(BaseModel):
    ...
    Estado: str = "Pedido"
    idPaquete: int | None = None
    idEnfermero: int | None = None
    nombreEnfermero: str | None = None
    Cirugia: str
    Ubicacion: str
